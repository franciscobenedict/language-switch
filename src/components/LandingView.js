...
const LandingView = () => {
  ...
  const [techUsedText, setTechUsedText] = useState('');
  ...
  useEffect(() => {
    if(languageName === "english") {
      ...
      setTechUsedText('Technologies used');
    }
    if(languageName === "spanish") {
      ...
      setTechUsedText('Tecnologías utilizadas');
    }
    if(languageName === "swedish") {
      ...
      setTechUsedText('Teknik som används');
    }
    if(languageName === "arabic") {
      ...
      setTechUsedText('التقنيات المستخدمة');
    }
